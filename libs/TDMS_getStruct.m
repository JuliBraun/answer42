function [output,metaStruct] = TDMS_getStruct(filePath,handles,structVersion,readOptions,structConvOptions)
...
%structVer handling
if nargin < 3 || isempty(structVersion)
    structVersion = DEFAULT_STRUCT_VERSION;
end

%readOptions
if nargin < 4 || isempty(readOptions)
    readOptions = {};
end

%structConvOptions
if nargin < 5 || isempty(structConvOptions)
    structConvOptions = {};
end
